...
if not api_key:
    raise ValueError("HuggingFace API key not found. Check your .env file.")
...
while True:
    try:
        ...
        with open(r"Frontend\\Files\\Image.data", "r") as f:
            Data: str = f.read()
        ...
        if Status.strip() == "True":
            ...
            with open(r"Frontend\\Files\\Image.data", "w") as f:
                f.write("False,False")
